    ...
    <>
      ...
      >
        <MuiAlert
          ...
          action={
            <>
              <Button color="error" size="small" onClick={() => setShowError(false)}>
                No
              </Button>
              <Button color="success" size="small" onClick={handleConfirmAddToCart}>
                Yes
              </Button>
            </>
          }
      ...
      <div className="course-section">
        <h2 className="outlined-text">
          All the skills you need <span className="color-effect">in one place</span>
        </h2>
