      ...
      <div className="course-container">
        <div className="course-header">
          ...
          <div className="course-info">
            <span className="icon">
              <CalendarMonth /> Duration: 6 months - 4 hours weekly ( 3 months training+ 3 months internship)
            </span>
            <span className="icon">
      ...
      <div className="MiddleMainDiv">
        <div className="MiddleContent">
          ...
          <div className="learnings-list">
            <ul>
              <li>Understand the theory and practical aspects of early childhood and care education.</li>
              <li>Apply educational theories such as Montessori and Regio Emelia, Piagets Theory of learning,
              Vygotsky, and Erik Erikson’s Theory of Psychological Development.</li>
             
            </ul>
            <ul>
            <li>
              Be sensitive and Reflect on the perspective and Challenges off early childhood promoting
              positive habits.
              </li>
              <li>
              Organize, Plan and Administer the day care Centre, preschool and deal children with the special
              needs (CWSN).
              </li>
