    ...
    <div>
      ...
      <div className="course-container">
        <div className="course-header">
          ...
          <h1 className="course-title">Burlington English Program</h1>
      ...
      <div className="MiddleMainDiv">
        <div className="MiddleContent">
          ...
          <div className="learnings-list">
            <ul>
              <li>
                Enhance skills in Listening, Speaking, Reading, and Writing
                through structured programs aligned with CEFR levels.
              </li>
              <li>
                Learn industry-specific vocabulary and communication skills
                tailored for various professions such as healthcare, IT,
                finance, and education.
              </li>
              <li>
                Develop essential workplace skills like teamwork, communication,
                problem-solving, and career planning strategies.
              </li>
            </ul>
            <ul>
              <li>
                Gain proficiency through VTest, an AI-driven adaptive test that
                accurately evaluates language levels across 10 CEFR levels.
              </li>
              <li>
                Experience AI-driven language learning, blended learning models,
                and interactive digital tools for personalized learning
                experiences.
              </li>
              <li>
                Understand the use of AI-driven proctoring, fraud detection, and
                GDPR-compliant testing environments for reliable assessments.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="course-features">
          ...
          {BurlingtonProgramModule.map((module, index) => (
            <Accordion
              key={index}
              sx={{
