      ...
      <div className="MiddleMainDiv">
        <div className="MiddleContent">
          ...
          <div className="learnings-list">
            <ul>
              <li>
                Appreciate the impact of leaders being at the Centre
                Professional Learning
              </li>
              <li>
                Identify, describe and escalate impactful strategies for school
                leaders.
              </li>
              <li>Design professional learning community at their school.</li>
            </ul>
            <ul>
              <li>Let SMART goals for a whole school development pathway.</li>
              <li>
                Determine measurement strategies and outcomes for future
                professional learning.
              </li>
              <li>
                Become inspirational role models and factor outstanding teacher
                performance.
              </li>
            </ul>
          </div>
