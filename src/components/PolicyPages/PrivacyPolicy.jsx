    ...
    <>
      ...
      <div className="privacy-container">
        <p className="common-title">
          Privacy <span className="color-effect">Policy</span>
        </p>
        <div className="policy-section">
          <p>
            Learn Leap values the trust you place in the Brand. That's why we
            insist upon the highest standards for secure transactions and
            customer information privacy. This Privacy Policy describes how
            Learn Leap and its affiliates collect and process your personal
            information through website and services.
          </p>
        </div>
        <div className="policy-section">
          <h2 className="common-heading">Note:</h2>
          <ul>
            <li>
              Our privacy policy and refund policy is subject to change at any
              time without notice. To make sure you are aware of any changes,
        ...
        <div className="policy-section">
          <h2 className="common-heading">
            Collecting Personally Identifiable & Other Information
          </h2>
          <p>
          ...
          <p>
            ...
            you based upon your behavior on our Website. We use this information
          ...
          <p>
            ...
            you may not be able to use certain features on the Website and you
          ...
          <p>
            ...
            otherwise described to you at the time of collection. In our efforts
            to continually improve our product and service offerings, we collect
          ...
          <p>
            ...
            information (like zip code, age, income level etc). We use this data
        ...
        <div className="policy-section">
          <h2 className="common-heading">Cookies</h2>
          <p>
        ...
        <div className="policy-section">
          <h2 className="common-heading">Sharing of personal information</h2>
          <p>
        ...
        <div className="policy-section">
          <h2 className="common-heading">Links to Other Sites</h2>
          <p>
            Our Website links to other websites that may collect personally
            identifiable information about you. LearnLeap is not responsible for
            the privacy practices or the content of those linked websites.
          </p>
        </div>
        <div className="policy-section">
          <h2 className="common-heading">Security Precautions</h2>
          <p>
        ...
        <div className="policy-section">
          <h2 className="common-heading"> Choice/Opt-Out</h2>
          <p>
            ...
            all Learn Leap and newsletters, please visit unsubscribe
            Advertisements on Learn Leap we use third-party advertising
            companies to serve ads when you visit our Website. These companies
            may use information (not including your name, address, email IDs,
            Mobile or telephone number) about your visits to this and other
            websites in order to provide advertisements about goods and services
            of interest to you.
          </p>
        </div>
        <div className="policy-section">
          <h2 className="common-heading"> You’re Consent</h2>
          <p>
        ...
        <div className="policy-section">
          <h2 className="common-heading">Grievance Officer</h2>
          <p>
