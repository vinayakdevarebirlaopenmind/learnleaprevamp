    ...
    <>
      ...
      <div className="privacy-container">
        ...
        <div className="policy-section">
          <p>
            LearnLeap values the trust you place in the Brand. That's why we
            ...
            LearnLeap and its affiliates collect and process your personal
        ...
        <div className="policy-section">
          ...
          <p>
            ...
            all LearnLeap and newsletters, please visit unsubscribe
            Advertisements on LearnLeap we use third-party advertising companies
            to serve ads when you visit our Website. These companies may use
            information (not including your name, address, email IDs, Mobile or
