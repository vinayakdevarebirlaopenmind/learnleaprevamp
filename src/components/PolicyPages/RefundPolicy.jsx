      ...
      <div className="privacy-container">
        ...
        <div className="policy-section">
          ...
          <ul>
            ...
            <li>
              <strong>Payment Security:</strong> Birla Learn Leap utilizes a
            ...
            <li>
              ...
              Learn Leap is not liable for any failure to communicate due to
        ...
        <div className="policy-section">
          <h3>By enrolling in a course, participants agree to the terms outlined in this refund policy</h3>
          <h3>For any questions or concerns regarding this policy, please contact</h3>
